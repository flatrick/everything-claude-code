...
I've built a continuous learning skill that does this. In this fork, the active implementation is `github.com/flatrick/modeldev-toolkit/tree/main/skills/continuous-learning-v2` via the `continuous-learning` package.
...
- In this fork, see `skills/continuous-learning-v2/` in this repo
