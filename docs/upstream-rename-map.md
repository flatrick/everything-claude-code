...
| `skills/continuous-learning/` | package `continuous-learning` -> `skills/continuous-learning-v2/` | Legacy v1 skill removed; upstream references to `continuous-learning` map to the v2 skill directory in this fork |
