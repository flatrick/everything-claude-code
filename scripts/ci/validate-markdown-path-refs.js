...
const DEFAULT_TARGET_PATHS = [
  ...
  path.join(ROOT_DIR, 'commands', 'AGENTS.md'),
  path.join(ROOT_DIR, 'skills', 'AGENTS.md'),
  path.join(ROOT_DIR, 'rules', 'AGENTS.md'),
  path.join(ROOT_DIR, 'hooks', 'AGENTS.md'),
  path.join(ROOT_DIR, 'scripts', 'AGENTS.md'),
  path.join(ROOT_DIR, 'tests', 'AGENTS.md'),
  path.join(ROOT_DIR, 'packages', 'AGENTS.md'),
  path.join(ROOT_DIR, 'workflow-contracts', 'AGENTS.md'),
  path.join(ROOT_DIR, 'docs', 'AGENTS.md'),
  path.join(ROOT_DIR, 'claude-template', 'AGENTS.md'),
  path.join(ROOT_DIR, 'cursor-template', 'AGENTS.md'),
  path.join(ROOT_DIR, 'codex-template', 'AGENTS.md'),
  path.join(ROOT_DIR, 'docs', 'tools', 'AGENTS.md'),
  path.join(ROOT_DIR, 'docs', 'testing', 'manual-verification', 'AGENTS.md'),
  path.join(ROOT_DIR, 'docs', 'plans', 'AGENTS.md'),
  path.join(ROOT_DIR, 'tests', 'compatibility-testing', 'AGENTS.md'),
