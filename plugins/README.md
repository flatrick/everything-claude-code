...
Plugins extend Claude Code with new tools and capabilities. This guide covers installation only - see [Affaan's upstream article about Claude Code plugins](https://x.com/affaanmustafa/status/2012378465664745795) for the original rationale and workflow context.
